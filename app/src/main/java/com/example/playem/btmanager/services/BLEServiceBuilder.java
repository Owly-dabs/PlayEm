...
public class BLEServiceBuilder {
    @SuppressLint("MissingPermission")
    public static void Build(PlayEmBTManager peBtManager, byte[] ReportMap){
        ...
        peBtManager.EnqueueServiceAdd(DIS_Service);
        peBtManager.EnqueueServiceAdd(HID_Service);
        peBtManager.EnqueueServiceAdd(BAT_Service); //Caller must start service add function;
